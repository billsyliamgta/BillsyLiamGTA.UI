...
namespace BillsyLiamGTA.UI.Elements
{
    ...
    public class Input
    {
        public static bool IsControlJustPressed(InputControl control)
        {
            return Function.Call<bool>(Hash.IS_DISABLED_CONTROL_JUST_PRESSED, 0, (int)control);
        }

        public static bool IsControlJustReleased(InputControl control)
        {
            return Function.Call<bool>(Hash.IS_CONTROL_JUST_RELEASED, 0, (int)control);
        }

        public static void DisableControlThisFrame(InputControl control)
        {
