...
namespace BillsyLiamGTA.UI.Menu
{
    public class UIMenuParentPanel
    {
        ...
        public void Draw(float y)
        {
            ...
            new SSprite(new TextureAsset("char_creator_portraits", getMomTextureName()), new PointF(safe.X - 2f + 20, safe.Y + y), new SizeF(225, 235), Color.FromArgb(AnimAlpha, 255, 255, 255)).Draw();
            new SSprite(new TextureAsset("char_creator_portraits", getDadTextureName()), new PointF(safe.X - 2f + 180, safe.Y + y), new SizeF(225, 235), Color.FromArgb(AnimAlpha, 255, 255, 255)).Draw();
